...
import com.wahyuade.kuisioner.penjual.FeeAgreementPenjual;
 ...
 */
public class MetodePembayaranPenjualFragment extends Fragment {
    ...
    public MetodePembayaranPenjualFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View metode_pembayaran =  inflater.inflate(R.layout.fragment_metode_pembayaran_penjual, container, false);
        ...
        final MetodePembayaranPenjualAdapter adapter = new MetodePembayaranPenjualAdapter(getActivity(), data_metode);
                ...
                if(count==1){
                    ...
                    perhatian.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(final DialogInterface dialogInterface, int i) {
                            ...
                            db.close();
                            if(indeks < 3){
                                ApiService.service_post.postPembayaranTertutupPenjual(data_email, Integer.toString(indeks)).enqueue(new Callback<DefaultModel>() {
                                    @Override
                                ...
                                ApiService.service_post.postPembayaranTerbukaPenjual(data_email, data_metode.get(indeks).getNama_metode()).enqueue(new Callback<DefaultModel>() {
                                    @Override
                                    public void onResponse(Call<DefaultModel> call, Response<DefaultModel> response) {
                                        progressDialog.dismiss();
                                        dialogInterface.dismiss();
