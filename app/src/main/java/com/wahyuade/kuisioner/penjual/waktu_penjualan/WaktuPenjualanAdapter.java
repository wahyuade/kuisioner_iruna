...
public class WaktuPenjualanAdapter extends ArrayAdapter {
    ...
    public WaktuPenjualanAdapter(ArrayList<HariModel> data, Context context) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        final WaktuPenjualanAdapter.ViewHolder viewHolder;
        final View result;

        if (convertView == null) {
            viewHolder = new WaktuPenjualanAdapter.ViewHolder();
            ...
            viewHolder = (WaktuPenjualanAdapter.ViewHolder) convertView.getTag();
            result=convertView;
        }
