...
public class MetodePembayaranAdapter extends RecyclerView.Adapter<MetodePembayaranAdapter.ListMetode> {
    Activity activity;
    ArrayList<MetodePembayaranModel> data_metode;

    public MetodePembayaranAdapter(Activity activity, ArrayList<MetodePembayaranModel> data_metode) {
