package com.wahyuade.kuisioner.pembeli.kebutuhan;
...
public class KebutuhanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View kebutuhan = inflater.inflate(R.layout.fragment_kebutuhan, container, false);
        ...
        final KebutuanAdapter adapter = new KebutuanAdapter(data_kebutuhan, getActivity());
                ...
                tambah.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(!kebutuhan.getText().toString().isEmpty()){
                            ...
                            db.close();
                            ApiService.service_post.postKebutuhanTerbukaPembeli(data_email, kebutuhan.getText().toString()).enqueue(new Callback<DefaultModel>() {
                                @Override
        ...
        lanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(count>0){
                    ...
                    String data_email = db.getEmail();
                    db.close();
                    ApiService.service_post.postKebutuhanTertutupPembeli(data_email,Boolean.toString(data_kebutuhan.get(0).isChecked()), Boolean.toString(data_kebutuhan.get(1).isChecked()), Boolean.toString(data_kebutuhan.get(2).isChecked()), Boolean.toString(data_kebutuhan.get(3).isChecked()), Boolean.toString(data_kebutuhan.get(4).isChecked()), Boolean.toString(data_kebutuhan.get(5).isChecked())).enqueue(new Callback<DefaultModel>() {
                        @Override
                        public void onResponse(Call<DefaultModel> call, Response<DefaultModel> response) {
                            progressDialog.dismiss();
                            getFragmentManager().beginTransaction().replace(R.id.pembeli_fragment, new ReferensiFragment(), "REFERENSI").commit();
                        }
