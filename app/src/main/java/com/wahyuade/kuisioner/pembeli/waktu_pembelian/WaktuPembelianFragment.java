 ...
 */
public class WaktuPembelianFragment extends Fragment {
    ArrayList<HariModel> data_hari;
    ListView list_hari;
    TextView lanjut;
    ProgressDialog progressDialog;
    public WaktuPembelianFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View waktu = inflater.inflate(R.layout.fragment_waktu_pembelian, container, false);
        ...
        WaktuPembelianAdapter adapter = new WaktuPembelianAdapter(data_hari, getActivity());
        ...
        lanjut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(count>0){
                    ...
                    db.close();
                    ApiService.service_post.postHariTransaksiPembeli(data_email, Boolean.toString(data_hari.get(0).isChecked()), Boolean.toString(data_hari.get(1).isChecked()), Boolean.toString(data_hari.get(2).isChecked()), Boolean.toString(data_hari.get(3).isChecked()), Boolean.toString(data_hari.get(4).isChecked()), Boolean.toString(data_hari.get(5).isChecked()), Boolean.toString(data_hari.get(6).isChecked())).enqueue(new Callback<DefaultModel>() {
                        @Override
                        public void onResponse(Call<DefaultModel> call, Response<DefaultModel> response) {
                            progressDialog.dismiss();
                            getFragmentManager().beginTransaction().replace(R.id.pembeli_fragment, new BukaFragment(), "BUKA_PEMBELI").commit();
                        }
